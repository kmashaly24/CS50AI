...
This repository contains my solutions for **CS50's Introduction to Artificial Intelligence with Python (CS50AI)**.
...
Through hands-on projects, i gain exposure to the theory behind graph search algorithms, classification, optimization, reinforcement learning, and other topics in artificial intelligence and machine learning as they incorporate them into their own Python programs.
...
- Solutions are my own implementations while learning CS50AI.
